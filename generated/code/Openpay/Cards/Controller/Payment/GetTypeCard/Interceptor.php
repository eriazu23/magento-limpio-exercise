...
class Interceptor extends \Openpay\Cards\Controller\Payment\GetTypeCard implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\Action\Context $context, \Openpay\Cards\Model\Payment $payment, \Psr\Log\LoggerInterface $logger_interface)
    {
        $this->___init();
        parent::__construct($context, $payment, $logger_interface);
    }
