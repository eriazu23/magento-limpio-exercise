...
/**
 * Generate bundle product based on profile configuration
 * Generated bundle selections are not displayed individually in catalog
 * Support the following format:
 * <bundle_products>{product amount}</bundle_products>
 * <bundle_products_options>{bundle product options amount}</bundle_products_options>
 * <bundle_products_variation>{amount of simple product per each option}</bundle_products_variation>
 *
...
class BundleProductsFixture extends Fixture
{
    ...
    {
        return 'Generating bundle product';
    }
