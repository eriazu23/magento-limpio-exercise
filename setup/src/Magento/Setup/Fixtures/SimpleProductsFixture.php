...
/**
 * Generate simple product based on profile configuration
 * Support the following format:
 * <simple_products>{product amount}</simple_products>
 ...
 * then product also will be distributed per additional attribute sets
 *
...
class SimpleProductsFixture extends Fixture
{
    ...
    {
        return 'Generating simple product';
    }
