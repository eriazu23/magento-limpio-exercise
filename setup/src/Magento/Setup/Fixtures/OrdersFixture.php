 ...
 *
 * <!-- Min number of simple product per each order -->
 * <order_simple_product_count_from>{int}</order_simple_product_count_from>
 *
 * <!-- Max number of simple product per each order -->
 * <order_simple_product_count_to>{int}</order_simple_product_count_to>
 *
 * <!-- Min number of configurable product per each order -->
 * <order_configurable_product_count_from>{int}</order_configurable_product_count_from>
 *
 * <!-- Max number of configurable product per each order -->
 * <order_configurable_product_count_to>{int}</order_configurable_product_count_to>
 *
 * <!-- Min number of big configurable product (with big amount of options) per each order -->
 * <order_big_configurable_product_count_from>{int}</order_big_configurable_product_count_from>
 *
 * <!-- Max number of big configurable product (with big amount of options) per each order -->
...
class OrdersFixture extends Fixture
{
    ...
    /**
     * Product type for "big" configurable product.
     *
     * @var string
     */
    ...
    private function getProductIds(\Magento\Store\Api\Data\StoreInterface $store, $typeId, $limit = null)
    {
        ...
        if ($limit && count($ids) < $limit) {
            throw new \RuntimeException('Not enough product of type: ' . $typeId);
        }
        return $ids;
    }

    /**
     * Prepare data for the simple product to be used as order items.
     *
    ...
    /**
     * Prepare data for the configurable product to be used as order items.
     *
     * Based on the Product Id's load data, which is required to replace placeholders in queries.
     *
     * @param array $productIds
