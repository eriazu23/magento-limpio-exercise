...
/**
 * Tests to check product to websites assigning.
 *
...
class ProductWebsiteLinkRepositoryTest extends WebapiAbstract
{
    ...
    public function testSaveWebsiteLinkWithUnexistingWebsiteId(): void
    {
        ...
        $serviceInfo = $this->fillServiceInfo('/V1/product/:sku/websites', Request::HTTP_METHOD_POST, 'Save');
        $requestData = [
            'productWebsiteLink' => [
    ...
    public function testDeleteWebsiteLink(): void
    {
        ...
        $resourcePath = sprintf('/V1/product/%s/websites/%u', $productSku, $websiteId);
