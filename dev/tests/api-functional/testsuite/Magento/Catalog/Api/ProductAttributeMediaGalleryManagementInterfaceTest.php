...
class ProductAttributeMediaGalleryManagementInterfaceTest extends WebapiAbstract
{
    ...
    protected function setUp(): void
    {
        ...
        $this->createServiceInfo = [
            'rest' => [
                'resourcePath' => '/V1/product/simple/media',
    ...
    public function testDelete()
    {
        ...
        $this->deleteServiceInfo['rest']['resourcePath'] = "/V1/product/simple/media/{$entryId}";
        $requestData = [
            'sku' => 'simple',
            'entryId' => $this->getTargetGalleryEntryId(),
        ];
    ...
    public function testCreateThrowsExceptionIfTargetProductDoesNotExist()
    {
        ...
        $this->createServiceInfo['rest']['resourcePath'] = '/V1/product/wrong_product_sku/media';
    ...
    public function testUpdateThrowsExceptionIfTargetProductDoesNotExist()
    {
        ...
        $this->updateServiceInfo['rest']['resourcePath'] = '/V1/product/wrong_product_sku/media'
            . '/' . 'wrong-sku';
        $requestData = [
    ...
    public function testDeleteThrowsExceptionIfTargetProductDoesNotExist()
    {
        ...
        $this->deleteServiceInfo['rest']['resourcePath'] = '/V1/product/wrong_product_sku/media/9999';
        $requestData = [
            'sku' => 'wrong_product_sku',
            'entryId' => 9999,
        ];
    ...
    public function testDeleteThrowsExceptionIfThereIsNoImageWithGivenId()
    {
        ...
        $this->deleteServiceInfo['rest']['resourcePath'] = '/V1/product/simple/media/9999';
        $requestData = [
            'sku' => 'simple',
            'entryId' => 9999,
        ];
    ...
    public function testDeleteThrowsExceptionIfTheImageCannotBeRemoved(): void
    {
        ...
        $this->deleteServiceInfo['rest']['resourcePath'] = strtr('/V1/product/sku/media/entryId', $requestData);
    ...
    public function testGet()
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/product/' . $productSku . '/media/' . $imageId,
    ...
    public function testGetList()
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/product/' . urlencode($productSku) . '/media',
                'httpMethod' => Request::HTTP_METHOD_GET,
            ],
            'soap' => [
                'service' => 'catalogProductAttributeMediaGalleryManagementV1',
