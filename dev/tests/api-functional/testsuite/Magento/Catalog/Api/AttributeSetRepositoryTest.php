...
class AttributeSetRepositoryTest extends WebapiAbstract
{
    ...
    public function testGet()
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/product/attribute-sets/' . $attributeSetId,
    ...
    public function testSave()
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/product/attribute-sets/' . $attributeSet->getId(),
    ...
    public function testGetList()
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/product/attribute-sets/sets/list' . '?' . http_build_query($searchCriteria),
                'httpMethod' => \Magento\Framework\Webapi\Rest\Request::HTTP_METHOD_GET,
            ],
            'soap' => [
                'service' => 'catalogAttributeSetRepositoryV1',
