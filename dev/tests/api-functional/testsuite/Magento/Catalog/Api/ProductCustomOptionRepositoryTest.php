...
class ProductCustomOptionRepositoryTest extends WebapiAbstract
{
    ...
    public function testRemove()
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => "/V1/product/$sku/options/$optionId",
    ...
    public function testGet()
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/product/' . $productSku . "/options/" . $optionId,
    ...
    public function testGetList()
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/product/' . $productSku . "/options",
                'httpMethod' => \Magento\Framework\Webapi\Rest\Request::HTTP_METHOD_GET,
            ],
            'soap' => [
                'service' => self::SERVICE_NAME,
    ...
    public function testSave($optionData)
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/product/options',
    ...
    public function testUpdate()
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/product/options/' . $optionId,
    ...
    public function testUpdateOptionAddingNewValue($optionType, $includedExisting, $expectedOptionValuesCount)
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/product/options/' . $fixtureOption->getId(),
                'httpMethod' => \Magento\Framework\Webapi\Rest\Request::HTTP_METHOD_PUT,
            ],
            'soap' => [
                'service' => self::SERVICE_NAME,
