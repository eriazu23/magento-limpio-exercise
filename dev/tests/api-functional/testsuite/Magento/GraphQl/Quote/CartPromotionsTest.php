...
class CartPromotionsTest extends GraphQlAbstract
{
    ...
    /**
     * Test adding single cart rule to multiple product in a cart
     *
    ...
    /**
     * Apply multiple cart rules to multiple product in a cart
     *
     * @magentoApiDataFixture Magento/Catalog/_files/multiple_products.php
     * @magentoApiDataFixture Magento/SalesRule/_files/rules_category.php
    ...
    /**
     * Apply cart rules to multiple product in a cart with taxes
     * Tax settings : Including and Excluding tax for Price Display and Shopping cart display
     * Discount on Prices Includes Tax
     * Tax rate = 7.5%
     * Cart rule to apply 50% for product assigned to a specific category
     *
     * @magentoApiDataFixture Magento/Catalog/_files/multiple_products.php
    ...
    /**
     * Test fixed discount cannot be higher than product price
     *
     * @magentoApiDataFixture Magento/Catalog/_files/multiple_products.php
     * @magentoApiDataFixture Magento/SalesRule/_files/coupon_code_with_wildcard.php
     */
