...
/**
 * Test product query for configurable product
 */
...
QUERY;
        ...
        $this->assertConfigurableProductOptions($response['product']['items'][0]);
        $this->assertConfigurableVariants($response['product']['items'][0]);
    }
    ...
    /**
     * Asserts various fields for child product for a configurable product
     *
