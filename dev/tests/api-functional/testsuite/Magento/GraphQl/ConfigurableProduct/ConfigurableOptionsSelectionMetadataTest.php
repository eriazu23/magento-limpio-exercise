...
QUERY;
        ...
        $this->assertEquals(1, count($response['product']['items']));
        $this->assertEquals(2, count($response['product']['items'][0]['configurable_product_options_selection']
            ['options_available_for_selection']));
        $this->assertEquals(4, count($response['product']['items'][0]['configurable_product_options_selection']
...
QUERY;
        ...
        $this->assertEquals(2, count($response['product']['items'][0]['configurable_product_options_selection']
            ['options_available_for_selection']));
        $this->assertEquals(1, count($response['product']['items'][0]['configurable_product_options_selection']
            ['options_available_for_selection'][0]['option_value_uids']));
        $this->assertEquals($firstOptionUid, $response['product']['items'][0]
        ...
        $this->assertAvailableOptionUids(
            ...
            $response['product']['items'][0]['configurable_product_options_selection']
                ['options_available_for_selection'][1]['option_value_uids']
        );
    }
...
QUERY;
        ...
        $this->assertEquals(1, count($response['product']['items'][0]['configurable_product_options_selection']
        ['options_available_for_selection'][0]['option_value_uids']));
        $this->assertEquals($lastOptionUid, $response['product']['items'][0]['configurable_product_options_selection']
...
QUERY;
        $response = $this->graphQlQuery($query);
        $this->assertEquals(1, count($response['product']['items']));
        $this->assertNotNull($response['product']['items'][0]['configurable_product_options_selection']
            ['variant']);
        $this->assertEquals(
...
QUERY;
        $response = $this->graphQlQuery($query);
        $this->assertEquals(1, count($response['product']['items']));
        $this->assertEquals(14, count($response['product']['items'][0]['configurable_product_options_selection']
            ['media_gallery']));
    }
