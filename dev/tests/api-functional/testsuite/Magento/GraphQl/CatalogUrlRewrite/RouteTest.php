...
QUERY;
        ...
        $urlPath = $response['product']['items'][0]['url_key'] . $response['product']['items'][0]['url_suffix'];
...
QUERY;
        $response = $this->graphQlQuery($query);
        $urlPath = $response['product']['items'][0]['url_key'] . $response['product']['items'][0]['url_suffix'];
        $suffix = $response['product']['items'][0]['url_suffix'];
...
QUERY;
        ...
        $this->assertEquals($urlPath, 'p002-new' . $response['product']['items'][0]['url_suffix']);
