...
QUERY;
        ...
        $this->assertArrayHasKey('stock_status', $response['product']['items'][0]);
        $this->assertEquals('IN_STOCK', $response['product']['items'][0]['stock_status']);
    }
...
QUERY;
        ...
        $this->assertArrayHasKey(0, $response['product']['items']);
        $this->assertArrayHasKey('stock_status', $response['product']['items'][0]);
        $this->assertEquals('OUT_OF_STOCK', $response['product']['items'][0]['stock_status']);
    }
}
