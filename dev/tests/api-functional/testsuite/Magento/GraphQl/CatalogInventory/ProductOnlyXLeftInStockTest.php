...
QUERY;
        ...
        $this->assertArrayHasKey('only_x_left_in_stock', $response['product']['items'][0]);
        $this->assertNull($response['product']['items'][0]['only_x_left_in_stock']);
    }
...
QUERY;
        ...
        $this->assertArrayHasKey(0, $response['product']['items']);
        $this->assertArrayHasKey('only_x_left_in_stock', $response['product']['items'][0]);
        $this->assertEquals(100, $response['product']['items'][0]['only_x_left_in_stock']);
    }
...
QUERY;
        ...
        $this->assertArrayHasKey(0, $response['product']['items']);
        $this->assertArrayHasKey('only_x_left_in_stock', $response['product']['items'][0]);
        $this->assertEquals(0, $response['product']['items'][0]['only_x_left_in_stock']);
    }
}
