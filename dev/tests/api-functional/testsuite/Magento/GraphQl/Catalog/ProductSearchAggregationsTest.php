...
class ProductSearchAggregationsTest extends GraphQlAbstract
{
    ...
    public function testAggregationBooleanAttribute()
    {
        ...
        $this->assertArrayHasKey('items', $result['product']);
        $this->assertCount(5, $result['product']['items']);
        $this->assertArrayHasKey('aggregations', $result['product']);

        $booleanAggregation = array_filter(
            $result['product']['aggregations'],
            function ($a) {
    ...
    /**
     * Get GraphQl product query with aggregations
     *
     * @param string $skus
     * @return string
     */
...
QUERY;
    ...
    /**
     * Get GraphQl product query with aggregations and items
     *
     * @param string $skus
     * @return string
     */
