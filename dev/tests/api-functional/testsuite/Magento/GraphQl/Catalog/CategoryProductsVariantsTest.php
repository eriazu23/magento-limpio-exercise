...
/**
 * Test of getting child product info of configurable product on category request
 */
...
QUERY;
        ...
        $this->assertArrayHasKey('variants', $response['category']['product']['items'][0]);
        $this->assertCount(2, $response['category']['product']['items'][0]['variants']);
        $this->assertSimpleProductFields($product, $response['category']['product']['items'][0]['variants'][0]);
    }
