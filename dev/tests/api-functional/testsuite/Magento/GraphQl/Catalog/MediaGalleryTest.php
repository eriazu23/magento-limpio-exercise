...
QUERY;
        ...
        self::assertArrayHasKey('url', $response['product']['items'][0]['small_image']);
...
QUERY;
        $response = $this->graphQlQuery($query);
        $responseImage = $response['product']['items'][0]['small_image'];
...
QUERY;
        $response = $this->graphQlQuery($query);
        $this->assertNotEmpty($response['product']['items'][0]['media_gallery_entries']);
        $mediaGallery = $response['product']['items'][0]['media_gallery_entries'];
...
QUERY;
        $response = $this->graphQlQuery($query);
        $this->assertNotEmpty($response['product']['items'][0]['media_gallery']);
        $mediaGallery = $response['product']['items'][0]['media_gallery'];
        $this->assertCount(2, $mediaGallery);
        $this->assertEquals('Image Alt Text', $mediaGallery[0]['label']);
...
QUERY;
        ...
        self::assertArrayHasKey('file', $response['product']['items'][0]['media_gallery_entries'][0]);
        self::assertStringContainsString(
            'magento_image.jpg',
            $response['product']['items'][0]['media_gallery_entries'][0]['file']
        );
    }
