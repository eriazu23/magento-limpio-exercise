...
QUERY;
        ...
        $this->assertArrayHasKey('product', $baseCategory);
        //Check base category product
...
QUERY;
    ...
    {
        $this->assertEquals(count($expectedProducts), $category['product']['total_count']);
        $this->assertCount(count($expectedProducts), $category['product']['items']);
        $this->assertResponseFields($category['product']['items'], $expectedProducts);
    }
