...
QUERY;
        $response = $this->graphQlQuery($query);
        $this->assertArrayHasKey('product', $response['categories']['items'][0]);
        $baseCategory = $response['categories']['items'][0];
        $this->assertArrayHasKey('total_count', $baseCategory['product']);
        $this->assertGreaterThanOrEqual(1, $baseCategory['product']['total_count']);
        $this->assertEquals(1, $baseCategory['product']['page_info']['current_page']);
        $this->assertEquals(20, $baseCategory['product']['page_info']['page_size']);
        $this->assertArrayHasKey('sku', $baseCategory['product']['items'][0]);
        $firstProduct = $baseCategory['product']['items'][0];
