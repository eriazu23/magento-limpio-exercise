...
QUERY;
        ...
        $this->assertEquals(
            ...
            $response['product']['items'][0]['links_purchased_separately']
        );
        $this->assertEquals($linksTitle, $response['product']['items'][0]['links_title']);
        $this->assertDownloadableProductLinks($downloadableProduct, $response['product']['items'][0]);
        $this->assertDownloadableProductSamples($downloadableProduct, $response['product']['items'][0]);
    }
...
QUERY;
        ...
        $this->assertEquals($linksTitle, $response['product']['items'][0]['links_title']);
        $this->assertEmpty($response['product']['items'][0]['downloadable_product_samples']);
        $this->assertNotEmpty(
            $response['product']['items'][0]['downloadable_product_links'],
        ...
        $this->assertResponseFields(
            $response['product']['items'][0]['downloadable_product_links'][0],
            [
