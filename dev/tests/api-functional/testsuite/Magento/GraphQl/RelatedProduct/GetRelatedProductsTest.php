...
/**
 * Test coverage for get related product
 */
...
QUERY;
        ...
        self::assertArrayHasKey('related_products', $response['product']['items'][0]);
        $relatedProducts = $response['product']['items'][0]['related_products'];
...
QUERY;
        ...
        self::assertCount(1, $response['product']['items']);
        self::assertArrayHasKey(0, $response['product']['items']);
        self::assertArrayHasKey('crosssell_products', $response['product']['items'][0]);
        $crossSellProducts = $response['product']['items'][0]['crosssell_products'];
...
QUERY;
        ...
        self::assertCount(1, $response['product']['items']);
        self::assertArrayHasKey(0, $response['product']['items']);
        self::assertArrayHasKey('upsell_products', $response['product']['items'][0]);
        $upSellProducts = $response['product']['items'][0]['upsell_products'];
