...
class TierPricesForCustomersTest extends GraphQlAbstract
{
    ...
    public function testTierPricesForGeneralGroup()
    {
        ...
        $this->assertNotEmpty($response['product']['items'][0]['tier_prices']);
        $this->assertArrayHasKey('tier_prices', $response['product']['items'][0]);
        ...
        $this->assertResponseFields($response['product']['items'][0]['tier_prices'], $expectedResponse);
        $this->assertCount(1, $response['product']['items'][0]['tier_prices']);
    }
    ...
    public function testTierPricesForGeneralAndAllCustomerGroups()
    {
        ...
        $this->assertResponseFields($response['product']['items'][0]['tier_prices'], $expectedResponse);
        $this->assertCount(2, $response['product']['items'][0]['tier_prices']);
    }
    ...
    public function testTierPricesForNotLoggedInGroupOnly()
    {
        ...
        // Query response with headers for customers
        $response = $this->graphQlQuery($query, [], '', $this->getHeaderMap());
        $this->assertEmpty($response['product']['items'][0]['tier_prices']);
