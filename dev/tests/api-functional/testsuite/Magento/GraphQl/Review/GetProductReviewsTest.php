...
QUERY;
        ...
        self::assertNotEmpty($response['product']['items']);

        $items = $response['product']['items'];
...
QUERY;
        ...
        self::assertArrayHasKey('items', $response['product']);
        self::assertNotEmpty($response['product']['items']);
        self::assertEquals(1, $response['product']['items'][0]['review_count']);
        self::assertCount(1, $response['product']['items'][0]['reviews']['items']);
    }
