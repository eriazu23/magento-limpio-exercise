...
/**
 * Test the caching works properly for product and categories
 */
class CacheTagTest extends GraphQlAbstract
{
    ...
    /**
     * Test if Magento cache tags and debug headers for product are generated properly
     *
...
query GetCategoryQuery(\$id: Int!, \$pageSize: Int!, \$currentPage: Int!) {
        category(id: \$id) {
            ...
            name
            product_count
            product(pageSize: \$pageSize, currentPage: \$currentPage) {
                items {
                    id
                    name
                    url_key
