...
class OrderInvoiceCreateTest extends \Magento\TestFramework\TestCase\WebapiAbstract
{
    ...
    /**
     * Tests that MAGETWO-95346 was fixed for bundled product
     *
    ...
    public function testOrderWithBundleInvoicedWithInvalidQuantitiesReturnsError()
    {
        ...
        $this->expectExceptionMessageMatches(
            ...
            . 'The invoice can\'t be created without product. Add product and try again./'
        );
    ...
    /**
     * Tests that MAGETWO-95346 was fixed for configurable product
     *
     * @codingStandardsIgnoreStart
     * @codingStandardsIgnoreEnd
