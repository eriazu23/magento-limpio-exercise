...
class LinkManagementTest extends WebapiAbstract
{
    ...
    const RESOURCE_PATH = '/V1/configurable-product';
    ...
    /**
     * Test if configurable option attribute positions are being preserved after simple product were assigned to a
    ...
    protected function addOptionToConfigurableProduct(
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/configurable-product/' . $productSku . '/options',
                'httpMethod' => Request::HTTP_METHOD_POST,
            ],
            'soap' => [
