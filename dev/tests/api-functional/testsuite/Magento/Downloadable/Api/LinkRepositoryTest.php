...
class LinkRepositoryTest extends WebapiAbstract
{
    ...
    protected function setUp(): void
    {
        $this->createServiceInfo = [
            'rest' => [
                'resourcePath' => '/V1/product/downloadable-product/downloadable-links',
    ...
    public function testUpdate()
    {
        ...
        $this->updateServiceInfo['rest']['resourcePath']
            = "/V1/product/downloadable-product/downloadable-links/{$linkId}";
        $requestData = [
            'isGlobalScopeContent' => false,
            'sku' => 'downloadable-product',
            'link' => [
    ...
    public function testUpdateThrowsExceptionIfTargetProductDoesNotExist()
    {
        ...
        $this->updateServiceInfo['rest']['resourcePath'] = '/V1/product/wrong-sku/downloadable-links/1';
        $requestData = [
            'isGlobalScopeContent' => true,
            'sku' => 'wrong-sku',
            'link' => [
    ...
    {
        $linkId = $this->getTargetLink($this->getTargetProduct())->getId();
        $this->deleteServiceInfo['rest']['resourcePath'] = "/V1/product/downloadable-links/{$linkId}";
        $requestData = [
            'id' => $linkId,
        ];
    ...
    public function testCreateThrowsExceptionIfTargetProductTypeIsNotDownloadable()
    {
        ...
        $this->createServiceInfo['rest']['resourcePath'] = '/V1/product/simple/downloadable-links';
        $requestData = [
            'isGlobalScopeContent' => false,
            'sku' => 'simple',
            'link' => [
    ...
    public function testCreateThrowsExceptionIfTargetProductDoesNotExist()
    {
        ...
        $this->createServiceInfo['rest']['resourcePath'] = '/V1/product/wrong-sku/downloadable-links';
        $requestData = [
            'isGlobalScopeContent' => false,
            'sku' => 'wrong-sku',
            'link' => [
