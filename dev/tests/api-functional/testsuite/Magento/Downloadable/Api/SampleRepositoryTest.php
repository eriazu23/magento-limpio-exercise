...
class SampleRepositoryTest extends WebapiAbstract
{
    ...
    protected function setUp(): void
    {
        ...
        $this->createServiceInfo = [
            'rest' => [
                'resourcePath' => '/V1/product/downloadable-product/downloadable-links/samples',
    ...
    public function testUpdate()
    {
        ...
        $this->updateServiceInfo['rest']['resourcePath']
            = "/V1/product/downloadable-product/downloadable-links/samples/{$sampleId}";
        $requestData = [
            'isGlobalScopeContent' => false,
            'sku' => 'downloadable-product',
            'sample' => [
    ...
    {
        $sampleId = $this->getTargetSample($this->getTargetProduct())->getId();
        $this->deleteServiceInfo['rest']['resourcePath'] = "/V1/product/downloadable-links/samples/{$sampleId}";
        $requestData = [
            'id' => $sampleId,
        ];
    ...
    public function testGetList($urlTail, $method, $expectations)
    {
        ...
        $serviceInfo = [
            'rest' => [
                'resourcePath' => '/V1/product/' . $sku . $urlTail,
    ...
    public function testCreateThrowsExceptionIfTargetProductTypeIsNotDownloadable()
    {
        ...
        $this->createServiceInfo['rest']['resourcePath'] = '/V1/product/simple/downloadable-links/samples';
        $requestData = [
            'isGlobalScopeContent' => false,
            'sku' => 'simple',
            'sample' => [
    ...
    public function testCreateThrowsExceptionIfTargetProductDoesNotExist()
    {
        ...
        $this->createServiceInfo['rest']['resourcePath'] = '/V1/product/wrong-sku/downloadable-links/samples';
        $requestData = [
            'isGlobalScopeContent' => false,
            'sku' => 'wrong-sku',
            'sample' => [
    ...
    public function testUpdateThrowsExceptionIfTargetProductDoesNotExist()
    {
        ...
        $this->updateServiceInfo['rest']['resourcePath'] = '/V1/product/wrong-sku/downloadable-links/samples/1';
        $requestData = [
            'isGlobalScopeContent' => true,
            'sku' => 'wrong-sku',
            'sample' => [
