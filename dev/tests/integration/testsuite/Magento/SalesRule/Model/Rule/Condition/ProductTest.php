...
class ProductTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Ensure that SalesRules filtering on category validates children product of configurables
     *
    ...
    public function testValidateCategorySalesRuleIncludesChildren($categoryId, $expectedResult)
    {
        ...
        // Load the SalesRule looking for product in a specific category
        /** @var $rule Rule */
    ...
    public function testValidateSalesRuleExcludesBundleChildren(): void
    {
        ...
        // Load the SalesRule looking for excluding product with selected sku
        /** @var $rule Rule */
