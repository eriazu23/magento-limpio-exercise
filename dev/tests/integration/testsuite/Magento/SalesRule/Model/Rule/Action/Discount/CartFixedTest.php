...
class CartFixedTest extends TestCase
{
    ...
    {
        return [
            'Discount $5 proportionally spread between product' => [
                5,
                [
                    'subtotal' => 10.00,
            ...
            'Discount $30 proportionally spread between product' => [
                30,
                [
                    'subtotal' => 10.00,
            ...
            'Discount $50 which is more then all subtotals combined proportionally spread between product' => [
                50,
                [
                    'subtotal' => 10.00,
