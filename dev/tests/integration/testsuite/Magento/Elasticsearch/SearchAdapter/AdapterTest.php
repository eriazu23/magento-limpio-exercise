 ...
 * @magentoDataFixture Magento/Framework/Search/_files/product.php
 *
...
class AdapterTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testSearchQueryBoost()
    {
         ...
         * The search keyword (antarctica) is mentioned twice only in one of the product.
         ...
         * how product are ordered in the search result
         */
        /** @var Attribute $attribute */
        ...
        $products = iterator_to_array($queryResponse);
        /*
         * As for the first case, we have two the same product.
