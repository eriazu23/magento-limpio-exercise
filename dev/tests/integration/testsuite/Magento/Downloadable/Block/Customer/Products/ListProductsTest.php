...
/**
 * Class to check My Downloadable product tab content
 *
 * @see ListProducts
...
class ListProductsTest extends TestCase
{
    ...
    /** @var string */
    private $statusXpath = "//table[@id='my-downloadable-product-table']"
    ...
    public function testNoItems(): void
    {
        ...
        $this->assertStringContainsString(
            (string)__('You have not purchased any downloadable product yet.'),
            strip_tags($html)
        );
    }
    ...
    private function createBlock(): ListProducts
    {
        ...
        $block->setTemplate('Magento_Downloadable::customer/product/list.phtml');
