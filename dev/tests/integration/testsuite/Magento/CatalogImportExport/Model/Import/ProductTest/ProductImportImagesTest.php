...
class ProductImportImagesTest extends ProductTestBase
{
    ...
    /**
     * Make sure the non existing image in the csv file won't erase the qty key of the existing product.
     */
    ...
    /**
     * Tests situation when images for importing product are already present in filesystem.
     *
