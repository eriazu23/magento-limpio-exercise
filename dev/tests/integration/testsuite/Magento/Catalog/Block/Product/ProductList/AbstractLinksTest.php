...
/**
 * Class AbstractLinks - abstract class when testing blocks of linked product
 *
...
abstract class AbstractLinksTest extends TestCase
{
    ...
    /**
     * Provide test data to verify the display of linked product.
     *
     * @return array
     */
    ...
    /**
     * Provide test data to verify the display of linked product on different websites.
     *
     * @return array
     */
    ...
    /**
     * Get test data to check position of related, up-sells and cross-sells product
     *
     * @return array
     */
    ...
    /**
     * Prepare a block of linked product
     *
     * @return void
     */
    ...
    /**
     * Set linked product by link type for current product received from array
     *
    ...
    /**
     * Get an array of received linked product
     *
     * @param array $items
     * @return array
     */
    ...
    /**
     * Link product to an existing product
     *
     * @param string $sku
    ...
    /**
     * Prepare the necessary websites for all product
     *
     * @return array
     */
