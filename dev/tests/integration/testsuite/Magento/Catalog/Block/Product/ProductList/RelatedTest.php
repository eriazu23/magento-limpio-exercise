...
/**
 * Check the correct behavior of related product on the product view page
 *
...
class RelatedTest extends AbstractLinksTest
{
    ...
    /**
     * Test the display of related product in the block
     *
    ...
    public function testDisplayRelatedProducts(array $data): void
    {
        ...
        $this->assertEquals(
            ...
            'Expected related product do not match actual related product!'
        );
    }

    /**
     * Test the position of related product in the block
     *
     * @magentoDataFixture Magento/Catalog/_files/product_simple.php
     * @magentoDataFixture Magento/Catalog/_files/products_list.php
     * @return void
    ...
    /**
     * Test the display of related product in the block on different websites
     *
