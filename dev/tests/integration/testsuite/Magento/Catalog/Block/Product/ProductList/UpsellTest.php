...
/**
 * Check the correct behavior of up-sell product on the product view page
 *
...
class UpsellTest extends AbstractLinksTest
{
    ...
    /**
     * Test the display of up-sell product in the block
     *
    ...
    public function testDisplayUpsellProducts(array $data): void
    {
        ...
        $this->assertEquals(
            ...
            'Expected up-sell product do not match actual up-sell product!'
        );
    }

    /**
     * Test the position of up-sell product in the block
     *
     * @magentoDataFixture Magento/Catalog/_files/product_simple.php
     * @magentoDataFixture Magento/Catalog/_files/products_list.php
     * @return void
    ...
    /**
     * Test the display of up-sell product in the block on different websites
     *
