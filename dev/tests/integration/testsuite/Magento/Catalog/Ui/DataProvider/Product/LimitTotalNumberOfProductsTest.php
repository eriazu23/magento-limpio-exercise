...
/**
 * Limit total number of product in grid collection test.
 */
class LimitTotalNumberOfProductsTest extends TestCase
{
    ...
    /**
     * Test limit total number of product is enabled and limit is reached.
     *
    ...
    /**
     * Test limit total number of product is enabled and limit is not reached.
     *
     * @magentoDataFixture Magento/Catalog/_files/products_list.php
     */
    ...
    /**
     * Test limit total number of product is disabled.
     *
     * @magentoDataFixture Magento/Catalog/_files/products_list.php
     */
