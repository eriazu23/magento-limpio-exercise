...
/**
 * Saving product with linked product
 */
class LinksTest extends TestCase
{
    ...
    /**
     * Test edit and remove simple related, up-sells, cross-sells product in an existing product
     *
    ...
    public function testEditRemoveRelatedUpSellCrossSellProducts(array $data): void
    {
        ...
        $this->assertEquals(
            ...
            "Expected linked product do not match actual linked product!"
        );
    }
    ...
    /**
     * Create an array of product by link type that will be linked
     *
    ...
    /**
     * Link related, up-sells, cross-sells product received from the array
     *
    ...
    /**
     * Get an array of received related, up-sells, cross-sells product
     *
     * @param ProductInterface|Product $product
     * @return array
     */
