 ...
 *
 * @magentoDataFixture Magento/Catalog/controllers/_files/product.php
...
class CompareTest extends AbstractController
{
    ...
    /**
     * Test clearing a list of compared product.
     *
     * @return void
     */
    ...
    /**
     * Assert that current visitor has exactly expected product in compare list
     *
