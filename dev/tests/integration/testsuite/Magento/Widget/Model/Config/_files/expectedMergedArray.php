    ...
    'new_products' => [
        ...
        'parameters' => [
            'display_type' => [
                ...
                'value' => 'all_products',
                'values' => [
                    'default' => ['value' => 'all_products', 'label' => 'All product'],
                    'item' => ['value' => 'new_products', 'label' => 'New product'],
                ],
                'visible' => '1',
                'required' => '1',
                'label' => 'Display Type',
                'description' => 'All product - recently added product, New product - product marked as new',
            ],
            'show_pager' => [
