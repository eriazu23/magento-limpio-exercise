 ...
 * - test product collection generation for sitemap
 *
...
class ProductTest extends \PHPUnit\Framework\TestCase
{
     ...
     * 1) Check that all product are loaded
     * 2) Check that product are loaded correctly and all required attributes present
     *
    ...
    {
        // Check all expected product were added into collection
        $this->assertCount($expectedCount, $products, 'Number of loaded product is incorrect');
