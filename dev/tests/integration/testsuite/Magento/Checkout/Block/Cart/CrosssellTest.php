...
/**
 * Check the correct behavior of cross-sell product in the shopping cart
 *
...
class CrosssellTest extends AbstractLinksTest
{
    ...
    /**
     * Test the display of cross-sell product in the block
     *
    ...
    public function testDisplayCrosssellProducts(array $data): void
    {
        ...
        $this->assertEquals(
            ...
            'Expected cross-sell product do not match actual cross-sell product!'
        );
    }

    /**
     * Test the position and max count of cross-sell product in the block
     *
     * @magentoDataFixture Magento/Checkout/_files/quote_with_simple_product_saved.php
     * @magentoDataFixture Magento/Catalog/_files/products_list.php
     * @magentoDataFixture Magento/Catalog/_files/product_simple_duplicated.php
    ...
    public function testPositionCrosssellProducts(): void
    {
        ...
        $this->assertCount(
            self::MAX_ITEM_COUNT,
            $items,
            'Expected quantity of cross-sell product do not match the actual quantity!'
        );
        $this->assertEquals(
    ...
    /**
     * Provide test data to verify the position of linked product of the last added product.
     *
     * @return array
     */
    ...
    /**
     * Test the display of cross-sell product in the block on different websites
     *
    ...
    /**
     * Test the invisibility of cross-sell product in the block which added to cart
     *
     * @magentoDataFixture Magento/Sales/_files/quote_with_multiple_products.php
     * @magentoDataFixture Magento/Catalog/_files/product_simple_duplicated.php
     * @return void
    ...
    /**
     * Get product of block when quote in checkout session
     *
