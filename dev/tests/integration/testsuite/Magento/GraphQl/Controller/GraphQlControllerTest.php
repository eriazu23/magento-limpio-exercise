...
QUERY;
        ...
        $this->assertNotEmpty($output['data']['product']['items'], 'Products array has items');
        $this->assertNotEmpty($output['data']['product']['items'][0], 'Products array has items');
        $this->assertEquals($product->getData($linkField), $output['data']['product']['items'][0]['id']);
        $this->assertEquals($product->getSku(), $output['data']['product']['items'][0]['sku']);
        $this->assertEquals($product->getName(), $output['data']['product']['items'][0]['name']);
    }
