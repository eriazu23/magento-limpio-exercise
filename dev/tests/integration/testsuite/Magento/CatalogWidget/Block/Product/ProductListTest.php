...
class ProductListTest extends TestCase
{
     ...
     * 2. Create 2 new product and select at least 2 multiselect options for one of these product
     * 3. Create product list widget condition based on the new multiselect attribute
     * 4. Set at least 2 options of multiselect attribute to match product for the product list widget
     * 5. Load collection for product list widget and make sure that number of loaded product is correct
     *
    ...
    {
        // Reindex EAV attributes to enable product filtration by created multiselect attribute
        ...
        // Load product collection filtered using specified conditions and perform assertions
    ...
    /**
     * Check product collection includes correct amount of product.
     *
     * @param int $count
     * @return void
    ...
    /**
     * Make sure CatalogWidget would display anchor category product recursively from children categories.
     *
     * 1. Create an anchor root category and a sub category inside it
     * 2. Create 2 new product and assign them to the sub categories
     * 3. Create product list widget condition to display product from the anchor root category
     * 4. Load collection for product list widget and make sure that number of loaded product is correct
     *
     * @magentoDbIsolation disabled
    ...
    public function testCreateAnchorCollection()
    {
        ...
        $this->assertEquals(
            2,
            $productCollection->count(),
            "Anchor root category does not contain product of it's children."
        );
    }
