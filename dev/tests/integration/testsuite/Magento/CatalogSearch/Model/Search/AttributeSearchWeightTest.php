...
/**
 * Test founded product order after quick search with changed attribute search weight using mysql search engine.
 *
...
class AttributeSearchWeightTest extends TestCase
{
    ...
    /**
     * Data provider with word for quick search, attributes weight and expected product name order.
     *
     * @return array
     */
