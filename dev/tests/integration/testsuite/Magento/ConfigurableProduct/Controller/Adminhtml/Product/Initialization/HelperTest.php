...
/**
 * Tests for image processing plugins for child product by saving a configurable product.
 *
...
class HelperTest extends TestCase
{
    ...
    /**
     * Tests adding images with various roles to child product by saving a configurable product.
     *
    ...
    /**
     * Tests replacing images with various roles to child product by saving a configurable product.
     *
     * @magentoDataFixture Magento/Catalog/_files/product_image.php
     * @magentoDataFixture Magento/ConfigurableProduct/_files/product_configurable.php
